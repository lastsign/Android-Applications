...
import com.example.olympus.data.ClubOlympusContract.MemberEntry;
...
public class OlympusDBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_MEMBERS_TABLE = "CREATE TABLE "  + MemberEntry.TABLE_NAME + "(" + MemberEntry._ID + " INTEGER PRIMARY KEY, "
